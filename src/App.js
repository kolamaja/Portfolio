	...
	return (
		<div className="flex flex-col justify-between h-screen ">
			...
			<footer className='bg-elephant-500'>
				<div className='container flex flex-row items-center py-12 px-8 mx-auto mt md:space-y-0'>
						<div className='flex flex-col space-y-3 text-2xl text-clay-500'>
							<a className="hover:text-clay-400" href='www.google.pl'><FaLinkedin/> </a>
							<a className="hover:text-clay-400" href='www.google.pl'><FaGithub/></a>
							<a className="hover:text-clay-400" href='www.google.pl'><FaEnvelope/></a>
						</div>
